...
public:
    Shooter(double position_x, double position_y, double vx_=600, double height=30, double width=18, double head_radius=8, Color color_=COLOR(0, 255, 0))
    {
        // Shooter constructor
        color = color_;
    ...
    //To be implemented when a bubble hits the shooter
    void change_color_to_blue()
    {
    ...
    // Change coloe back to blue afte bubble hits shooter
